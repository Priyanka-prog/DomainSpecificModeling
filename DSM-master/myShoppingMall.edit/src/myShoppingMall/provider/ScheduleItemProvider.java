...
/**
 * This is the item provider adapter for a {@link myShoppingMall.Schedule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_StartTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_StartTime_feature", "_UI_Schedule_type"),
				 MyShoppingMallPackage.Literals.SCHEDULE__START_TIME,
				 true,
				 false,
				 false,
	...
	protected void addEndTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_EndTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_EndTime_feature", "_UI_Schedule_type"),
				 MyShoppingMallPackage.Literals.SCHEDULE__END_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Date labelValue = ((Schedule)object).getStartTime();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Schedule.class)) {
			case MyShoppingMallPackage.SCHEDULE__START_TIME:
			case MyShoppingMallPackage.SCHEDULE__END_TIME:
