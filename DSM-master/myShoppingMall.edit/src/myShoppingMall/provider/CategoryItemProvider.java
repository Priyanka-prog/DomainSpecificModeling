...
/**
 * This is the item provider adapter for a {@link myShoppingMall.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_CategoryName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_CategoryName_feature", "_UI_Category_type"),
				 MyShoppingMallPackage.Literals.CATEGORY__CATEGORY_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MyShoppingMallPackage.Literals.CATEGORY__CONTAINS);
		}
	...
	public String getText(Object object) {
		String label = ((Category)object).getCategoryName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MyShoppingMallPackage.Literals.CATEGORY__CONTAINS,
				 MyShoppingMallFactory.eINSTANCE.createSubCategory()));
	}
