...
<asm version="1.0" name="0">
	<cp>
		<constant value="M2Mtransformation"/>
		...
		<constant value="A.__matchBranded2Brand():V"/>
		<constant value="A.__matchSchedule2Schedule():V"/>
		<constant value="__exec__"/>
		<constant value="Employee2Employee"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyEmployee2Employee(NTransientLink;):V"/>
		<constant value="Branded2Brand"/>
		<constant value="A.__applyBranded2Brand(NTransientLink;):V"/>
		<constant value="Schedule2Schedule"/>
		<constant value="A.__applySchedule2Schedule(NTransientLink;):V"/>
		<constant value="__matchEmployee2Employee"/>
		<constant value="Employee"/>
		<constant value="Shops"/>
		<constant value="IN"/>
		...
		<constant value="12:3-14:27"/>
		<constant value="__applyEmployee2Employee"/>
		<constant value="NTransientLink;"/>
		<constant value="NTransientLink;.getSourceElement(S):J"/>
		<constant value="NTransientLink;.getTargetElement(S):J"/>
		<constant value="3"/>
		<constant value="EmployeeName"/>
		<constant value="schedule"/>
		<constant value="13:12-13:13"/>
		<constant value="13:12-13:26"/>
		<constant value="13:4-13:26"/>
		<constant value="14:16-14:17"/>
		<constant value="14:16-14:26"/>
		<constant value="14:4-14:26"/>
		<constant value="link"/>
		<constant value="__matchBranded2Brand"/>
		<constant value="Branded"/>
		<constant value="Brands"/>
		<constant value="22:3-24:30"/>
		<constant value="__applyBranded2Brand"/>
		...
		<constant value="24:17-24:28"/>
		<constant value="24:4-24:28"/>
		<constant value="__matchSchedule2Schedule"/>
		<constant value="Schedule"/>
		<constant value="31:3-33:25"/>
		<constant value="__applySchedule2Schedule"/>
		<constant value="StartTime"/>
		<constant value="startTime"/>
		<constant value="EndTime"/>
		<constant value="endTime"/>
		<constant value="32:17-32:18"/>
		<constant value="32:17-32:28"/>
		<constant value="32:4-32:28"/>
		<constant value="33:15-33:16"/>
		<constant value="33:15-33:24"/>
		<constant value="33:4-33:24"/>
	</cp>
	<field name="1" type="2"/>
	<field name="3" type="4"/>
	<operation name="5">
