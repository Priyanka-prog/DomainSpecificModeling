 ...
 * @generated
 */
public class MyShoppingMallDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public MyShoppingMallDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof myShoppingMall.diagram.navigator.MyShoppingMallDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((myShoppingMall.diagram.navigator.MyShoppingMallDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new myShoppingMall.diagram.navigator.MyShoppingMallDomainNavigatorItem((EObject) objects[i],
