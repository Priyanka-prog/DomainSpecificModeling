 ...
 * 
 */
package myShoppingMall.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(myShoppingMall.diagram.part.MyShoppingMallDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(myShoppingMall.diagram.part.Messages.MessageFormatParser_InvalidInputError,
