 ...
 * @generated
 */
public class MyShoppingMallMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = myShoppingMall.diagram.part.MyShoppingMallDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			myShoppingMall.diagram.part.MyShoppingMallDiagramEditorUtil.selectElementsInDiagram(editor,
