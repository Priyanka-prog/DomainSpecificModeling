 ...
 * @generated
 */
public class SpecialisticItemSemanticEditPolicy
		extends myShoppingMall.diagram.edit.policies.MyShoppingMallBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public SpecialisticItemSemanticEditPolicy() {
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (myShoppingMall.diagram.part.MyShoppingMallVisualIDRegistry.getVisualID(node)) {
			case myShoppingMall.diagram.edit.parts.SpecialisticSpecialisticEmployeesCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (myShoppingMall.diagram.part.MyShoppingMallVisualIDRegistry.getVisualID(cnode)) {
