 ...
 * @generated
 */
public class ItemItemNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ItemItemNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = myShoppingMall.diagram.providers.MyShoppingMallParserProvider.getParser(
					myShoppingMall.diagram.providers.MyShoppingMallElementTypes.Item_3003, getParserElement(),
