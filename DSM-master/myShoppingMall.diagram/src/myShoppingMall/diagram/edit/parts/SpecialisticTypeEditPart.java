 ...
 * @generated
 */
public class SpecialisticTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SpecialisticTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = myShoppingMall.diagram.providers.MyShoppingMallParserProvider.getParser(
					myShoppingMall.diagram.providers.MyShoppingMallElementTypes.Specialistic_2006, getParserElement(),
