 ...
 * @generated
 */
public class EmployeeEmployeeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmployeeEmployeeName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = myShoppingMall.diagram.providers.MyShoppingMallParserProvider.getParser(
					myShoppingMall.diagram.providers.MyShoppingMallElementTypes.Employee_3006, getParserElement(),
