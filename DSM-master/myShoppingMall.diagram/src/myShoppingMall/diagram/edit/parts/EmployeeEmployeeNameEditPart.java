 ...
 * @generated
 */
public class EmployeeEmployeeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmployeeEmployeeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = myShoppingMall.diagram.providers.MyShoppingMallParserProvider.getParser(
					myShoppingMall.diagram.providers.MyShoppingMallElementTypes.Employee_2004, getParserElement(),
