 ...
 * @generated
 */
public class SubCategorySubCategoryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SubCategorySubCategoryNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new myShoppingMall.diagram.edit.policies.MyShoppingMallTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return myShoppingMall.diagram.providers.MyShoppingMallElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = myShoppingMall.diagram.providers.MyShoppingMallParserProvider.getParser(
					myShoppingMall.diagram.providers.MyShoppingMallElementTypes.SubCategory_3005, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					myShoppingMall.diagram.edit.parts.MyShoppingMallEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
